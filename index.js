...
/////////////////
const BotName = 'Gis Bot☄'; 
const instagram = 'https://instagram.com/akiragisti11'; 
const telegram = 'https://t.me/Gisss'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@akiragisti11')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@akiragisti11`)
})
